...
const LandingPageIntro = () => {
	return (
		<div className='bg-blue-500 text-white py-16 px-12 my-8 text-center rounded-md'>
			...
			<p className='text-xl font-semibold px-7'>
				...
				selection, enjoy fast shipping,
				and experience hassle-free
				returns.
			</p>
			<p className='mt-6 text-lg px-8'>
				Start shopping today and find
				exactly what you need, all at
				unbeatable prices!
			</p>
		</div>
	);
